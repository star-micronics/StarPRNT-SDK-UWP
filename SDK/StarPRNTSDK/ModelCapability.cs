        ...
        public static Dictionary<int, PrinterModel> ModelTypeDictionary
        {
            get
            {
                return new Dictionary<int, PrinterModel>()
                {
                    ...
                    { 2,  PrinterModel.MCL32 },
                    { 3,  PrinterModel.POP10},
                    { 4,  PrinterModel.FVP10 },
                    { 5,  PrinterModel.TSP100 },
                    { 6,  PrinterModel.TSP100IV },
                    { 7,  PrinterModel.TSP650II},
                    { 8,  PrinterModel.TSP700II },
                    { 9,  PrinterModel.TSP800II },
                    { 10,  PrinterModel.SP700 },
                    { 11,  PrinterModel.S210i },
                    { 12, PrinterModel.S220i },
                    { 13, PrinterModel.S230i },
                    { 14, PrinterModel.T300i},
                    { 15, PrinterModel.T400i },
