        ...
        public static Dictionary<int, PrinterModel> ModelTypeDictionary
        {
            get
            {
                return new Dictionary<int, PrinterModel>()
                {
                    ...
                    { 2,  PrinterModel.MCL21 },
                    { 3,  PrinterModel.MCL32 },
                    { 4,  PrinterModel.POP10},
                    { 5,  PrinterModel.FVP10 },
                    { 6,  PrinterModel.TSP100 },
                    { 7,  PrinterModel.TSP100IV },
                    { 8,  PrinterModel.TSP650II},
                    { 9,  PrinterModel.TSP700II },
                    { 10,  PrinterModel.TSP800II },
                    { 11,  PrinterModel.SP700 },
                    { 12,  PrinterModel.S210i },
                    { 13, PrinterModel.S220i },
                    { 14, PrinterModel.S230i },
                    { 15, PrinterModel.T300i},
                    { 16, PrinterModel.T400i },
                    { 17, PrinterModel.L200 },
                    { 18, PrinterModel.L300 },
                    { 19, PrinterModel.BSC10 },
                    { 20, PrinterModel.BSC10II },
                    { 21, PrinterModel.S210i_StarPRNT },
                    { 22, PrinterModel.S220i_StarPRNT},
                    { 23, PrinterModel.S230i_StarPRNT},
                    { 24, PrinterModel.T300i_StarPRNT },
                    { 25, PrinterModel.T400i_StarPRNT },
                    { 26, PrinterModel.Unknown },
                };
            }
        }
